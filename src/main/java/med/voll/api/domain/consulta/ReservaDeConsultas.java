...
public class ReservaDeConsultas {
    ...
    public void cancelar(DatosCancelamientoConsulta datos) {
        ...
        var diferenciaEnHoras = java.time.Duration.between(ahora, consulta.getFecha()).toHours();

        if (diferenciaEnHoras < 24) {
            throw new ValidacionException("¡Consulta solo puede ser cancelada con antecedencia mínima de 24 horas!");
        }
